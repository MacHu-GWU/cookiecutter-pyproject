# -*- coding: utf-8 -*-
#
# my_package documentation build configuration file, created by
...
copyright = '{}, Firstname Lastname'.format(datetime.utcnow().year, package.__author__)
...
# Add data for Jinja2
try:
    from my_package.docs import doc_data
except:
    doc_data = dict()
