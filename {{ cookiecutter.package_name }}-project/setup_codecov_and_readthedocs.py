...
if __name__ == "__main__":
    ...
    codecov_owner_username = "{{ cookiecutter.github_username }}"
    codecov_token_name = "{{ cookiecutter.codecov_token_name }}"
    github_owner_username = "{{ cookiecutter.github_username }}"
    github_token_name = "{{ cookiecutter.github_token_name }}"
    readthedocs_owner_username = "{{ cookiecutter.readthedocs_username }}"
    readthedocs_token_name = "{{ cookiecutter.readthedocs_token_name }}"
    readthedocs_project_name = "{{ cookiecutter.package_name }}"
